...
<body>
    <div class="container">
        <div class="signin-container shadow">
            ...
            <form id="frm" action="confirmsignin.php" method="post" class="needs-validation" novalidate>
                <!-- Username Field -->
                <div class="mb-3">
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn btn-custom" id="btn" name="signin" >Sign In</button>
            </form>
        </div>
    </div>
